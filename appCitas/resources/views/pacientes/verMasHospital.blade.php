...
<div class="container mt-3">
    <div class="row">
        <div class="col-md-6 offset-md-1 p-3 rounded">
    ...
    <div class="row mt-3 justify-content-center">
        <div class="col-md-10">
            <div class="medico p-3 text-white rounded" style="border-radius: 13px; display: flex; align-items: center; justify-content: space-between;">
                <h2 class="medico m-0" style="margin-left: 20px!important; letter-spacing: 5px;">MEDICOS</h2>
            </div>
        </div>
    </div>
</div>
