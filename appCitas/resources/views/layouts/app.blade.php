        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
            ...
            <li class="nav-item d-flex align-items-center mr-3">
              @if(auth()->check())
                  <a href="{{ route('perfil.editar') }}" class="nav-link text-white font-weight-bold px-0 mr-3" style="font-size: 20px; justify-content: center; align-items: center; display: flex; margin-right: 20px;">
